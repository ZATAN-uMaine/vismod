...
class TestPreProcessor(unittest.TestCase):
    ...
    def test_apply_calibration(self):
        ...
        calib_table = {
            ...
            "Wind Sensor": {"Sensor ID": "14441"},
            "Contact Info": ["test@gmail.com", "test1@gmail.com"],
